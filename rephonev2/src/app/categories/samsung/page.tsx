...
export default function SamsungPage() {
  const samsungProducts = product_data.filter(
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600">
            Explore our collection of refurbished Samsung phones
          </p>
        </motion.div>
        ...
        {samsungProducts.length > 0 ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">
              No Samsung phones found
            </h3>
            <p className="text-gray-600 mb-6">
              Check back later for more Samsung models!
            </p>
          </motion.div>
        )}
      </div>
